...
- jsonp
- javascript
background-image: https://i.pinimg.com/originals/af/e9/21/afe9219d7dc0bb2b255d82ddbf9a872e.png
...
**文章有一句写的很好，就是jsonp技术实际就是字符串拼接，其核心是将返回数据放在拼接上回调函数名，并以js文件形式运行方法调用，从而将数据传回并进一步处理。**
